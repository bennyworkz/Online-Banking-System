	...
	<div class="page-content">
		<div class="form-v4-content">
			<div class="form-left">
				...
				<a href="Registration_Page.jsp"><div class="form-left-last" style="position: relative;top: 20%;left:25%"> 
					<input type="submit" name="account" class="account" value="Not a Member?" >
				</div></a>
			</div>
			<form class="form-detail" action="LoginServlet" method="post" id="myform">
				<b><h3>LOGIN</h3></b>
